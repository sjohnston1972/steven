...
Technologies he designs and delivers on: Palo Alto with Panorama, GlobalProtect, WildFire and Prisma Access; Cisco Firepower Threat Defence and FMC; Cisco ASA and ASAv; Fortinet; Cisco Meraki MX; zero trust and ZTNA; SASE and Cisco Secure Access; Umbrella and DNS-layer security; network segmentation; IoT, OT and CCTV segmentation; TrustSec security group tags; IPsec and IKEv2; remote access VPN; security architecture.
Platforms he has worked alongside rather than owned: Check Point and Juniper firewalls, and Extreme core switching, have all appeared in estates he has delivered into. He has integrated with them, assessed them, reconfigured what the project required, and in some cases migrated off them, but he was not the responsible engineer for those platforms. Be precise about this distinction if asked, and do not present them as platforms he specialises in.

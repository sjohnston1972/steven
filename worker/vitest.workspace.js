...
export default defineWorkspace([
    {
        test: {
            name: "unit",
            include: ["test/personas.test.js", "test/persona-sync.test.js", "test/auth.test.js", "test/chat-log.test.js", "test/chat-handler.test.js"],
            environment: "node",
        },
    },
    defineWorkersConfig({
        test: {
            ...
            exclude: ["test/personas.test.js", "test/persona-sync.test.js", "test/auth.test.js", "test/chat-log.test.js", "test/chat-handler.test.js"],
            poolOptions: {
                workers: {
                    miniflare: {
